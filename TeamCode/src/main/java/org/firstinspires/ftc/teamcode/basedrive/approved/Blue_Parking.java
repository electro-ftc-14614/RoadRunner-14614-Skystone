...
@Autonomous(name = "BLUE:PARKING", group = "Electrobot")
//@Disabled
public class Blue_Parking extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        moveRobot(ElectroBot.DIRECTIONS.RIGHT,3);


/*
        robot.aem.setPower(-0.35); //extending ARM out
        sleep(800);
        Log.i(ElectroBot.LOGTAG, "BQB: Stop moving the ARM");
        robot.aem.setPower(0.0);
        this.sleep(2000);


        Log.i(ElectroBot.LOGTAG, "Pulling ARM Back in");
        Log.i(ElectroBot.LOGTAG,""+robot.getcssposition());
        robot.aem.setPower(0.35);
        Log.i(ElectroBot.LOGTAG, "Sleep for 800 millisecs");
        Log.i(ElectroBot.LOGTAG,""+robot.getcssposition());
        this.sleep(800);
        Log.i(ElectroBot.LOGTAG, "Stop moving ARM");
        robot.aem.setPower(0);
        this.sleep(2000);
