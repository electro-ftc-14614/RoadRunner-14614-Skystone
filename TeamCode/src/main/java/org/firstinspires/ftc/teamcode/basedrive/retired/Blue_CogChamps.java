...
@Autonomous(name = "BLUE:COGCHAMP", group = "2Main_Auto")
@Disabled
public class Blue_CogChamps extends LinearOpMode {
    ...
    protected void getSkystoneFromPos1() {
        ...
        moveRobot(ElectroBot.DIRECTIONS.BACKWARD, 9, false);
        stopIntakeMotors();
        this.sleep(100);
        turnOnIntakeMotors();
    ...
    protected void getSkystoneFromPos2() {
        ...
        robot.turnClockwise(87.5, TURN_SPEED);
        this.sleep(300);
        ...
        moveRobot(ElectroBot.DIRECTIONS.LEFT, 15.0, false);
    ...
    protected void getSkystoneFromPos3() {
        ...
        robot.turnClockwise(39, TURN_SPEED);
    ...
    protected void getStoneFromPos2() {
        ...
        moveRobot(ElectroBot.DIRECTIONS.FORWARD, 59, false);
        ...
        Log.i(ElectroBot.LOGTAG, "BQB: Travel back to cross the bridge and drop the stone");
        moveRobot(ElectroBot.DIRECTIONS.BACKWARD, 64, DRIVE_SPEED , true);
    ...
    protected void getStoneFromPos3() {
        ...
        robot.setArmServos(-0.4);
        Log.i(ElectroBot.LOGTAG, "BQB: Travel back to cross the bridge and drop the stone");
        moveRobot(ElectroBot.DIRECTIONS.BACKWARD, 10, DRIVE_SPEED , true);
        robot.setArmServos(0);
    ...
    protected void getStoneFromPos1() {
        Log.i(ElectroBot.LOGTAG, "BQB: travel back to quarry side");
        moveRobot(ElectroBot.DIRECTIONS.FORWARD, 47, false);
        //Log.i(ElectroBot.LOGTAG, "Bridge Heading after travel back to quarry: " + robot.getYaw());
        ...
        moveRobot(ElectroBot.DIRECTIONS.BACKWARD, 48, .7, true);
        robot.setArmServos(0);
    ...
    protected void intakeSecondSkystone(int pos){
        ...
        if(pos==3){
            moveRobot(ElectroBot.DIRECTIONS.LEFT, 19, false);
        }
        else
        {
            moveRobot(ElectroBot.DIRECTIONS.LEFT, 18, false);
        }
        turnOnIntakeMotors();
        moveRobot(ElectroBot.DIRECTIONS.FORWARD,8,false);
        if(pos==3)
        {
            moveRobot(ElectroBot.DIRECTIONS.RIGHT, 14.5, false);
        }
        else{
    ...
    protected void parkUnderBridge() {
        ...
        moveRobot(ElectroBot.DIRECTIONS.FORWARD, 31.0, .99, true);
    }
    ...
    private void moveFoundation(int position) {
        ...
        this.sleep(250);
        robot.setArmServos(-0.395); //extending ARM out

        //pulling WaffleMaker
        Log.i(ElectroBot.LOGTAG, "BQB: Travel back at slower speed towards team wall");
        if (position == 3) {
            moveRobot(ElectroBot.DIRECTIONS.FORWARD, 10, 0.3, false);

        } else {
            moveRobot(ElectroBot.DIRECTIONS.FORWARD, 9, 0.3, false);
        }
    ...
    private void checkDriveMotorsWithHeading(double speed,double targetpos) {
        ...
        while ((opModeIsActive()) && robot.isRobotMoving()) {
            ...
            if (local_speed < speed)
            {
                Log.i(ElectroBot.LOGTAG, "Increasing speed");
