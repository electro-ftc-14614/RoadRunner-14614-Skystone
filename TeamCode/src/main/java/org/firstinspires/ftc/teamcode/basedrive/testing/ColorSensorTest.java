...
@Autonomous(name = "ColorSensorTest", group = "1Electrobot")
@Disabled
public class ColorSensorTest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while(opModeIsActive())
        {
            ...
            //moveRobot(ElectroBot.DIRECTIONS.FORWARD, 24.0);
            this.sleep(100);
            Color.RGBToHSV((int) (cs1.red() * SCALE_FACTOR),
                    (int) (cs1.green() * SCALE_FACTOR),
                    (int) (cs1.blue() * SCALE_FACTOR),
                    hsvValues);

            // send the info back to driver station using telemetry function.

            Log.i(ElectroBot.LOGTAG, "ColorSensor1 Red = " + cs1.red() + ":: G = " + cs1.green() + ":: Alpha = " + cs1.alpha());
            Log.i(ElectroBot.LOGTAG, "ColorSensor1 H: " + hsvValues[0] + " ,S: " + hsvValues[1] + " , V: " + hsvValues[2]);

            Color.RGBToHSV((int) (cs2.red() * SCALE_FACTOR),
                    (int) (cs2.green() * SCALE_FACTOR),
                    (int) (cs2.blue() * SCALE_FACTOR),
                    hsvValues);

            Log.i(ElectroBot.LOGTAG, "ColorSensor2 Red = " + cs2.red() + ":: G = " + cs2.green() + ":: Alpha = " + cs2.alpha());
            Log.i(ElectroBot.LOGTAG, "ColorSensor2 H: " + hsvValues[0] + " ,S: " + hsvValues[1] + " , V: " + hsvValues[2]);

            //this.sleep(1000);
            Log.i(ElectroBot.LOGTAG, "Drive forward to park under bridge");
            //robot.logDriveEncoderPosition();
            //moveRobot(ElectroBot.DIRECTIONS.BACKWARD, 24);
